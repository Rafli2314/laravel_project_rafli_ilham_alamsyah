...
<div class="dropdown">
<button class="btn p-0" type="button" id="cardOpt3" data-bs-
...
<div class="dropdown">
<button class="btn p-0" type="button" id="cardOpt6" data-bs-
toggle="dropdown" aria-haspopup="true" aria-expanded="false">
<i class="bx bx-dots-vertical-rounded"></i>
</button>
<div class="dropdown-menu dropdown-menu-end" aria-
...
<small class="text-success fw-semibold">
<i class="bx bx-up-arrow-alt"></i> +28.42%<i class="bx bx-up-arrow-alt"></i> +28.42%
</small>
</div>
</div>
</div>
